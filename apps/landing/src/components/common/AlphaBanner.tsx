// apps/landing/src/components/common/AlphaBanner.tsx
'use client';
...
export default function AlphaBanner() {
  ...
  return (
    <div className="bg-yellow-400 text-yellow-900 p-3 text-center text-sm shadow-md relative">
      <p>
        <strong>Version Alpha :</strong> Cette plateforme est en phase de test.
        Utilisez avec prudence, préférentiellement sur des réseaux de test.
        Vos <a href="/feedback" className="underline hover:text-yellow-700">retours</a> sont précieux !
      </p>
      <button
