// apps/token-creator/src/components/common/FeedbackButton.tsx
'use client';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[100]">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
              Merci de nous aider à améliorer BlockDeploy (Token Creator) ! Cette application est en version Alpha.
            ...
            <ul className="list-disc list-inside mb-6 text-sm space-y-1">
              {discordLink && ( // Vérifier si le lien existe
                <li>
              ...
              <li>
                Email : <a href={`mailto:${supportEmail}?subject=Feedback Alpha - Token Creator`} className="text-sky-500 hover:underline">{supportEmail}</a>
              </li>
            </ul>
