// apps/token-creator/src/components/common/AlphaBanner.tsx
'use client';
...
export default function AlphaBanner() {
  ...
  // Lien de feedback spécifique à token-creator, ou un lien générique
  const feedbackLink = "/feedback-token-creator"; // ou "/feedback"

  return (
    <div className="bg-yellow-400 text-yellow-900 p-3 text-center text-sm shadow-md relative">
      <p>
        <strong>Version Alpha :</strong> Cette application (Token Creator) est en phase de test.
